...
/**
 * @brief The MemoryPatch class represents a memory patch for applying
 * modifications to a memory address.
 *
 * @details The MemoryPatch class allows for the creation and management of
 * memory patches, including:
...
public:
   ...
   *
   * @param absolute_address The absolute address in memory where the patch will
   * be applied.
   ...
   *
   * @param absolute_address The absolute address where the patch should be
   * applied.
