...
public:
  ...
  /**
   * @brief Reads data from the file at a given offset without changing file
   * pointer.
   *
  ...
  /**
   * @brief Writes data to the file at a given offset without changing file
   * pointer.
   *
   ...
   * @param mode The permissions to use when creating directories (default:
   * 0755).
   *
