...
{
  static Il2Cpp::Assembly *(*il2cpp_domain_assembly_open)(const char *) =
      reinterpret_cast<decltype(il2cpp_domain_assembly_open)>(g().memory->getUnityBase() +
                                                              g().memory->offsets.assembly_open);
...
{
  return *reinterpret_cast<const char **>(reinterpret_cast<uintptr_t>(assembly) +
                                          g().memory->offsets.assembly_name);
}

Il2Cpp::Image *Il2CppApi::getImage(Il2Cpp::Assembly *assembly)
{
  static Il2Cpp::Image *(*il2cpp_assembly_get_image)(Il2Cpp::Assembly *) =
      reinterpret_cast<decltype(il2cpp_assembly_get_image)>(g().memory->getUnityBase() +
                                                            g().memory->offsets.assembly_get_image);
  return il2cpp_assembly_get_image(assembly);
}

int Il2CppApi::getTypeCount(Il2Cpp::Image *image)
{
  return *reinterpret_cast<int *>(reinterpret_cast<uintptr_t>(image) +
                                  g().memory->offsets.image_type_count);
}

std::vector<Il2Cpp::Class *> Il2CppApi::getClasses(Il2Cpp::Image *image)
{
  std::vector<Il2Cpp::Class *> result;
  static void *(*get_assembly_type_handle)(Il2Cpp::Image *, int index) =
      reinterpret_cast<decltype(get_assembly_type_handle)>(
          g().memory->getUnityBase() + g().memory->offsets.image_get_assembly_type_handle);

  static Il2Cpp::Class *(*get_type_from_handle)(void *) =
      reinterpret_cast<decltype(get_type_from_handle)>(
...
{
  return *reinterpret_cast<const char **>(reinterpret_cast<uintptr_t>(image) +
                                          g().memory->offsets.image_name);
}
...
{
  static const char *(*il2cpp_class_get_name)(Il2Cpp::Class *) =
      reinterpret_cast<decltype(il2cpp_class_get_name)>(g().memory->getUnityBase() +
                                                        g().memory->offsets.class_get_name);
  return il2cpp_class_get_name(klass);
}

const char *Il2CppApi::getClassNamespace(Il2Cpp::Class *klass)
{
  return *reinterpret_cast<const char **>(reinterpret_cast<uintptr_t>(klass) +
                                          g().memory->offsets.class_namespace);
}

Il2Cpp::Class *Il2CppApi::getParent(Il2Cpp::Class *klass)
{
  static Il2Cpp::Class *(*il2cpp_class_get_parent)(Il2Cpp::Class *) =
      reinterpret_cast<decltype(il2cpp_class_get_parent)>(g().memory->getUnityBase() +
                                                          g().memory->offsets.class_get_parent);
  return il2cpp_class_get_parent(klass);
}

std::vector<Il2Cpp::Field *> Il2CppApi::getFields(Il2Cpp::Class *klass)
{
  static Il2Cpp::Field *(*il2cpp_get_fields)(Il2Cpp::Class *, void *) =
      reinterpret_cast<decltype(il2cpp_get_fields)>(g().memory->getUnityBase() +
                                                    g().memory->offsets.class_get_fields);
...
{
  static Il2Cpp::Field *(*il2cpp_get_properties)(Il2Cpp::Class *, void *) =
      reinterpret_cast<decltype(il2cpp_get_properties)>(g().memory->getUnityBase() +
                                                        g().memory->offsets.class_get_properties);
...
{
  static Il2Cpp::Method *(*il2cpp_get_class_methods)(Il2Cpp::Class *, void *) =
      reinterpret_cast<decltype(il2cpp_get_class_methods)>(g().memory->getUnityBase() +
                                                           g().memory->offsets.class_get_methods);
...
{
  return reinterpret_cast<Il2Cpp::Type *>(reinterpret_cast<uintptr_t>(klass) +
                                          g().memory->offsets.class_type);
}

bool Il2CppApi::isClassEnum(Il2Cpp::Class *klass)
{
  static Il2Cpp::Type *(*il2cpp_class_get_enum_basetype)(Il2Cpp::Class *) =
      reinterpret_cast<decltype(il2cpp_class_get_enum_basetype)>(
...
{
  static int64_t (*il2cpp_class_get_flags)(Il2Cpp::Class *) =
      reinterpret_cast<decltype(il2cpp_class_get_flags)>(g().memory->getUnityBase() +
                                                         g().memory->offsets.class_get_flags);
  return il2cpp_class_get_flags(klass);
}

std::vector<Il2Cpp::Class *> Il2CppApi::getInterfaces(Il2Cpp::Class *klass)
{
  static Il2Cpp::Class *(*il2cpp_get_class_interfaces)(Il2Cpp::Class *, void *) =
      reinterpret_cast<decltype(il2cpp_get_class_interfaces)>(
...
{
  static Il2Cpp::Class *(*il2cpp_class_get_declaring_type)(Il2Cpp::Class *) =
      reinterpret_cast<decltype(il2cpp_class_get_declaring_type)>(
...
{
  static uint8_t (*il2cpp_class_is_generic)(Il2Cpp::Class *) =
      reinterpret_cast<decltype(il2cpp_class_is_generic)>(g().memory->getUnityBase() +
                                                          g().memory->offsets.class_get_is_generic);
  return il2cpp_class_is_generic(klass) == 1;
}

const char *Il2CppApi::getFieldName(Il2Cpp::Field *field)
{
  static const char *(*il2cpp_field_get_name)(Il2Cpp::Field *) =
      reinterpret_cast<decltype(il2cpp_field_get_name)>(g().memory->getUnityBase() +
                                                        g().memory->offsets.field_get_name);
  return il2cpp_field_get_name(field);
}

int32_t Il2CppApi::getFieldOffset(Il2Cpp::Field *field)
{
  static int32_t (*il2cpp_field_get_offset)(Il2Cpp::Field *) =
      reinterpret_cast<decltype(il2cpp_field_get_offset)>(g().memory->getUnityBase() +
                                                          g().memory->offsets.field_get_offset);
  return il2cpp_field_get_offset(field);
}

Il2Cpp::Type *Il2CppApi::getFieldType(Il2Cpp::Field *field)
{
  static Il2Cpp::Type *(*il2cpp_field_get_type)(Il2Cpp::Field *) =
      reinterpret_cast<decltype(il2cpp_field_get_type)>(g().memory->getUnityBase() +
                                                        g().memory->offsets.field_get_type);
  return il2cpp_field_get_type(field);
}

void *Il2CppApi::getFieldDefaultValue(Il2Cpp::Field *field, Il2Cpp::Type **type)
{
  static void *(*il2cpp_get_field_default_value)(Il2Cpp::Field *, Il2Cpp::Type **) =
      reinterpret_cast<decltype(il2cpp_get_field_default_value)>(
...
{
  static int8_t (*il2cpp_type_get_type)(Il2Cpp::Type *) =
      reinterpret_cast<decltype(il2cpp_type_get_type)>(g().memory->getUnityBase() +
                                                       g().memory->offsets.type_get_type);
  return il2cpp_type_get_type(type);
}

int16_t Il2CppApi::getAttrs(Il2Cpp::Type *type)
{
  return *reinterpret_cast<int16_t *>(reinterpret_cast<uintptr_t>(type) +
                                      g().memory->offsets.type_attrs) >>
         g().memory->offsets.type_attrs_shift;
}

Il2Cpp::Class *Il2CppApi::getClassFromType(Il2Cpp::Type *type)
{
  static Il2Cpp::Class *(*il2cpp_class_from_il2cpp_type)(Il2Cpp::Type *, char) =
      reinterpret_cast<decltype(il2cpp_class_from_il2cpp_type)>(
...
{
  static void *(*il2cpp_type_get_data)(Il2Cpp::Type *) =
      reinterpret_cast<decltype(il2cpp_type_get_data)>(g().memory->getUnityBase() +
                                                       g().memory->offsets.type_get_data);
...
{
  static std::string (*il2cpp_type_get_name)(Il2Cpp::Type *, uint8_t) =
      reinterpret_cast<decltype(il2cpp_type_get_name)>(g().memory->getUnityBase() +
                                                       g().memory->offsets.type_get_name);
...
{
  return *reinterpret_cast<const char **>(reinterpret_cast<uintptr_t>(property) +
                                          g().memory->offsets.property_name);
}

Il2Cpp::Method *Il2CppApi::getPropertySetter(Il2Cpp::Property *property)
{
  return *reinterpret_cast<Il2Cpp::Method **>(reinterpret_cast<uintptr_t>(property) +
                                              g().memory->offsets.property_set_method);
}

Il2Cpp::Method *Il2CppApi::getPropertyGetter(Il2Cpp::Property *property)
{
  return *reinterpret_cast<Il2Cpp::Method **>(reinterpret_cast<uintptr_t>(property) +
                                              g().memory->offsets.property_get_method);
}

const char *Il2CppApi::getMethodName(Il2Cpp::Method *method)
{
  return *reinterpret_cast<const char **>(reinterpret_cast<uintptr_t>(method) +
                                          g().memory->offsets.method_name);
}

Il2Cpp::Type *Il2CppApi::getMethodReturnType(Il2Cpp::Method *method)
{
  return *reinterpret_cast<Il2Cpp::Type **>(reinterpret_cast<uintptr_t>(method) +
                                            g().memory->offsets.method_return_type);
}

int16_t Il2CppApi::getMethodFlags(Il2Cpp::Method *method)
{
  static int16_t (*il2cpp_method_get_flags)(Il2Cpp::Method *method) =
      reinterpret_cast<decltype(il2cpp_method_get_flags)>(g().memory->getUnityBase() +
                                                          g().memory->offsets.method_get_flags);
  return il2cpp_method_get_flags(method);
}

int8_t Il2CppApi::getParameterCount(Il2Cpp::Method *method)
{
  return *reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(method) +
                                      g().memory->offsets.method_parameters_count);
}

Il2Cpp::Type *Il2CppApi::getParameter(Il2Cpp::Method *method, size_t index)
{
  static Il2Cpp::Type *(*il2cpp_method_get_parameter)(Il2Cpp::Method *, size_t index) =
      reinterpret_cast<decltype(il2cpp_method_get_parameter)>(
...
uintptr_t Il2CppApi::getMethodRealVirtualAddress(Il2Cpp::Method *method)
{
  return *reinterpret_cast<uintptr_t *>(reinterpret_cast<uintptr_t>(method) +
                                        g().memory->offsets.method_pointer);
}

uintptr_t Il2CppApi::getMethodVirtualAddress(Il2Cpp::Method *method)
{
  return *reinterpret_cast<uintptr_t *>(reinterpret_cast<uintptr_t>(method) +
                                        g().memory->offsets.method_virtual_pointer);
}

uint16_t Il2CppApi::getMethodSlot(Il2Cpp::Method *method)
{
  return *reinterpret_cast<uint16_t *>(reinterpret_cast<uintptr_t>(method) +
                                       g().memory->offsets.method_slot);
}

uint8_t Il2CppApi::getMethodIsGeneric(Il2Cpp::Method *method)
{
  static uint8_t (*il2cpp_method_is_generic)(Il2Cpp::Method *method) =
      reinterpret_cast<decltype(il2cpp_method_is_generic)>(
...
{
  static const char *(*il2cpp_get_parameter_name)(Il2Cpp::Method *, size_t) =
      reinterpret_cast<decltype(il2cpp_get_parameter_name)>(
